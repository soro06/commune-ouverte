                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            <input class="form-control form-control-solid colours" name="code" id="code" type="text" value="" placeholder="<?= lang('Parametres.code') ?>"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <input class="form-control form-control-solid colours" name="designation" type="text" value="" placeholder="<?= lang('Parametres.designation') ?>">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="border_bottom">
                        ...
                        if (isset($menu)) {
                            foreach ($menu as $rows) {
                                ?>
                                <tr>
                                    <td style="width: 100px;"><input type="checkbox" class="checkbox" onchange="ed_activate_action(this)" name="menu[]" data-id="<?= $rows->menu_id ?>" id="ed_menu_<?= $rows->menu_id ?>" value="<?= $rows->list_id ?>" /></td>
                                    <td><input type="hidden" id="del_menu_<?= $rows->menu_id ?>" value="<?= $rows->menu_id ?>"/><?= $rows->designation ?></td>
                                    <td class="text-center"><input type="hidden" class="p_input p_view" id="ed_menu_p_view_<?= $rows->menu_id ?>" value="0"/><input disabled onchange="ed_set_p_value(this)" type="checkbox" class="ck_action checkbox view"  data-target="#ed_menu_p_view_<?= $rows->menu_id ?>" id="ed_menu_view_<?= $rows->menu_id ?>" /></td>
                                    <td class="text-center"><input type="hidden" class="p_input p_new" id="ed_menu_p_new_<?= $rows->menu_id ?>" value="0"/><input disabled onchange="ed_set_p_value(this)" type="checkbox" class="ck_action checkbox new" data-target="#ed_menu_p_new_<?= $rows->menu_id ?>" id="ed_menu_new_<?= $rows->menu_id ?>" /></td>
                                    <td class="text-center"><input type="hidden" class="p_input p_edit" id="ed_menu_p_edit_<?= $rows->menu_id ?>" value="0"/><input disabled onchange="ed_set_p_value(this)" type="checkbox" class="ck_action checkbox edit" data-target="#ed_menu_p_edit_<?= $rows->menu_id ?>" id="ed_menu_edit_<?= $rows->menu_id ?>" /></td>
                                    <td class="text-center"><input type="hidden" class="p_input p_delete" id="ed_menu_p_delete_<?= $rows->menu_id ?>" value="0"/><input disabled onchange="ed_set_p_value(this)" type="checkbox" class="ck_action checkbox delete" data-target="#ed_menu_p_delete_<?= $rows->menu_id ?>" id="ed_menu_delete_<?= $rows->menu_id ?>" /></td>
                                </tr>
                                <?php
                            }
                        }
    ...
    var jvalidate = $("#frm_profils").validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                type: "post",
                dataType: "JSON",
                url: "<?php echo base_url('administration/user_profile_save'); ?>",
