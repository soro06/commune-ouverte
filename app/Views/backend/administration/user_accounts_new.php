                ...
                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="home-tab-1">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <input class="form-control form-control-solid colours" name="code" id="code" type="text" value="" placeholder="<?= lang('Admin.code') ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    ...
                                    <input class="form-control form-control-solid colours" id="designation" name="designation" type="text" value="" placeholder="<?= lang('Admin.name') ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <select data-placeholder="<?= lang('Admin.profile') ?>" name = "profile" id="profile" class="form-control form-control-solid colours " style="width: 100%;">
                                        ...
                                        <?php foreach ($profile as $row) { ?>
                                            <option class="option_color" value="<?php echo $row->user_profile_id; ?>"><?php echo $row->user_profile_designation; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <select data-placeholder="<?= lang('Admin.language') ?>" name = "language" id="language" class="form-control form-control-solid colours " style="width: 100%;">
                                        <option selected="" value=""></option>
                                        <option value="english"><?= lang('Admin.english') ?></option>
                                        <option selected="" value="french"><?= lang('Admin.french') ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <label class="col-form-label"><?= lang('Admin.password') ?></label>
                                </div>
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <input class="form-control form-control-solid colours" name="password" id="password" type="password" value="" placeholder="<?= lang('Admin.password') ?>" />
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <input class="form-control form-control-solid colours" name="cpassword" id="cpassword" type="password" value="" placeholder="<?= lang('Admin.confirm_password') ?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <select data-placeholder="<?= lang('Admin.member') ?>" name = "member" id="member" class="form-control form-control-solid " style="width: 100%;">
                                        ...
                                        <?php foreach ($member as $rows) { ?>
                                            <option class="option_color" value="<?php echo $rows->member_id; ?>"><?php echo $rows->member_code.' - '.$rows->member_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <input class="form-control form-control-solid" name="validityperiod" id="validityperiod" type="text" value="" placeholder="<?= lang('Admin.validity_period') ?>" />
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                ...
                                <div class="col-lg-1 col-md-1 col-sm-12">
                                    <label class="checkbox newcheckb">
                                        <input type="checkbox" name="mobile_acces" id="mobile_acces" class="checkbox" value="1" />
                                        <span></span></label> 
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    ...
                                    <input class="form-control form-control-solid" id="address" name="address" type="text" value="" placeholder="<?= lang('Admin.address') ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <input class="form-control form-control-solid" name="zipcode" id="zipcode" type="text" value="" placeholder="<?= lang('Admin.zip_code') ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <select data-placeholder="<?= lang('Admin.country') ?>" name = "country" id="country" class="form-control form-control-solid" style="width: 100%;">
                                        ...
                                        <?php foreach ($country as $rows) { ?>
                                            <option class="option_color" value="<?php echo $rows->country_id; ?>"><?php echo $rows->country_code . ' - ' . $rows->country_designation; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <input class="form-control form-control-solid" name="city" id="city" type="text" value="" placeholder="<?= lang('Admin.city') ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <input class="form-control form-control-solid" name="phoneno" id="phoneno" type="text" value="" placeholder="<?= lang('Admin.phone_number') ?>" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <input class="form-control form-control-solid" id="email" name="email" type="text" value="" placeholder="<?= lang('Admin.email') ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                if ($sector) {
                                    foreach ($sector as $row) {
                                        ?>
                                        <tr>
                                            <td class="text-center"><input id="ck_sector_<?= $row->sector_id ?>" onchange ="filter_branch(this)" type="checkbox" name="sectors[]"  value="<?= $row->sector_id ?>" /></td>
                            ...
                            <tbody>
                                ...
                                if ($branch) {
                                    foreach ($branch as $row) {
                                        ?>
                                        <tr>
                                            <td class="text-center"><input id="ck_branch_<?= $row->branch_id ?>" onchange ="filter_cost_center(this)" data-sector ="<?= $row->branch_sector_id ?>" class="ck_branch" type="checkbox" name="branchs[]" value="<?= $row->branch_id ?>" /></td>
                            ...
                            <tbody>
                                ...
                                if ($cost_center) {
                                    foreach ($cost_center as $row) {
                                        ?>
                                        <tr>
                                            <td class="text-center"><input data-branch ="<?= $row->cost_center_branch_id ?>" data-sector ="<?= $row->sector_id ?>" class="ck_cost_center" type="checkbox" name="cost_centers[]" value="<?= $row->cost_center_id ?>" /></td>
    ...
    var jvalidate = $("#frm_user_account").validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                ...
                type: "post",
                dataType: "JSON",
                url: "<?php echo base_url('administration/user_accounts_save'); ?>",
